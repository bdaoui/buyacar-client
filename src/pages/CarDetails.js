      ...
      <section className='flex flex-col lg:flex-row w-screen h-full'>
          ...
          <div className='w-full lg:w-3/4 h-screen text-base flex flex-col lg:flex-row gap-5 lg:gap-10'>
            <section className='flex md:w-1/4 flex-col gap-y-5 lg:gap-y-10 text-center lg:text-left'>
              ...
              <p>Prix: <span className='italic text-gold'>{car?.price +"€"}</span></p>
            ...
            <section className='flex md:w-1/4 flex-col gap-y-5 lg:gap-y-10 text-center lg:text-left'>
              ...
              <p>Moteur: <span className='italic text-gold'>{car?.engine}L</span></p>
              <p>Nombre de portes: <span className='italic text-gold'>{car?.doors}</span></p>
              <p>Nombre de place(s): <span className='italic text-gold'>{car?.seats}</span></p>
