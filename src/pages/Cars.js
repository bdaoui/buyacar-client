              ...
              <div className="bg-emerald-500 rounded-lg border border-gray-200 shadow-2xl">
                <Link to={`/${car._id}`}>
                  ...
                  <div className="p-5 text-center">                      
                      ...
                      <Link to={`/${car._id}`} className="inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-emerald-700 rounded-lg hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300">
                          See more
