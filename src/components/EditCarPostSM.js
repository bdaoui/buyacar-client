...
const EditCarPostSM = ({handleCarEdit, selectedId, filteredCar, setPrice, setMake, setFuel, setColor, setBestDeal, setBody, setDoors, setEngine, setMileage, setYear, setTransmission,setSeats, handleAllImageDelete, imageIndex, handleImageDelete, previousImage, nextImage, setImage, setModel, setDescription, validateSending}) => {
  return (
    <form
        className="mt-10"
