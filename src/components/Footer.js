...
const Footer = () => {
  return (
    <footer className="p-0 h-10 bg-black text-xs md:text-base flex flex-col md:flex-row items-center md:justify-between md:p-6">
      <ul className="flex flex-wrap items-center mt-3 text-white sm:mt-0">
        <li>
        ...
        <li className="flex ">
          ...
          <span className="hover:underline md:mr-6 font-semibold text-gold">
            +33 3923 2903
          </span>
        </li>
      </ul>
