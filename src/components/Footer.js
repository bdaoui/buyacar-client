  ...
  return (
    <footer className="p-0 h-16 md:h-10 bg-black text-sm md:text-base flex flex-col md:flex-row items-center md:justify-between md:p-6">
        <ul className="flex flex-wrap items-center mt-3 text-lg text-white sm:mt-0">
            <li>
                <span className="mr-1 text-center">N'hésitez pas à me contacter au </span>
            </li>
            <li className='flex relative '> 
            <svg xmlns="http://www.w3.org/2000/svg" fill="gold" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="mr-2 w-4 h-4 absolute top-2 left-4">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                </svg>
                <span className="mr-4 hover:underline md:mr-6 font-semibold pl-10 text-gold">+33 3923 2903</span>
            </li>
        </ul>
