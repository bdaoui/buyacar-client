...
const Testimonial = () => {
  ...
  return (
    ...
    <svg aria-hidden="true" className="w-5 h-5 text-gold  w-1/6  my-auto " fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 19l-7-7 7-7" ></path></svg> 
    {testimonial.map(item => 

    <section key={item._id} className="flex flex-col w-4/6 m-auto">
    ...
    <svg aria-hidden="true" className="w-5 h-5 text-gold my-auto  w-1/6   " fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5l7 7-7 7" ></path></svg>
