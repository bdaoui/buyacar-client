  ...
  return (
    ...
    <section className="flex flex-col w-1/2 gap-y-2 md:gap-y-5">
      ...
      <p className="flex justify-left pl-10 md:pl-32">
        ...
        <p className="flex justify-left pl-10 md:pl-32"><BsCurrencyEuro className="md:mt-1 mr-2 text-lg"/> 
        <span className="italic text-gold">{car?.price}</span></p>
      
        <p className="flex justify-left pl-10 md:pl-32">
        <FaRoad className="md:mt-1 mr-2 text-lg" />
        <span className="italic text-gold">{car?.mileage}km</span>
      </p>
    
      <p className="flex justify-left pl-10 md:pl-32">
        <TfiSpray className="md:mt-1 mr-2 text-lg"/> <span className="italic text-gold">{car?.color}</span>
      </p>

      <p className="flex justify-left pl-10 md:pl-32">
        <RiGasStationFill className="md:mt-1 mr-2 text-lg"/> <span className="italic text-gold">{car?.fuel}</span>
      </p>
   
</section>
<section className="flex flex-col w-1/2 gap-y-2 md:gap-y-5">
    <p className="flex justify-left pl-10 md:pl-32">
        <GiGearStickPattern className="md:mt-1 mr-2 text-lg"/>
        <span className="italic text-gold">{car?.transmission}</span>
      </p>

      <p className="flex justify-left pl-10 md:pl-32">
        <TbEngine className="md:mt-1 mr-2 text-lg"/> <span className="italic text-gold">{car?.engine} L</span>
      </p>
     
      <p className="flex justify-left pl-10 md:pl-32">
        <GiCarDoor className="md:mt-1 mr-2 text-lg"/>
        <span className="italic text-gold">{car?.doors}</span>
      </p>

      <p className="flex justify-left pl-10 md:pl-32">
        <GiCarSeat className="md:mt-1 mr-2 text-lg"/>
        <span className="italic text-gold">{car?.seats}</span>
      </p>

      <p className="flex justify-left pl-10 md:pl-32">
        <BsFillCalendar2DateFill className="md:mt-1 mr-2 text-lg"/>
